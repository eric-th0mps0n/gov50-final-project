...
Here in these tables we see the difference in means between voters that have either served in the military or current do (Military-Affiliated Voters) vs. voters that have never served in the military (Non-Military Affiliated Voters). The estimated average treatment effect suggests that military-affiliated voters are 2.07 percentage points more likely to vote for candidates that are military veterans themselves than non-military affiliated voters are. 

Continuing into the project further, I will develop a p-value, a confidence interval, and some further visuals to determine how significant this difference is. At first glance, the difference does not appear significant, and honestly I expected the gap to be much wider. It could possibly be that voters simply vote along party lines, regardless of the candidate and their military affiliation. 
